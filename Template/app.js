(function () {
    ...
    //UNITY STUFF
    var buildUrl = "Build";
    var loaderUrl = buildUrl + "/1.0.18 WebGL Build.loader.js";
    var config = {
        dataUrl: buildUrl + "/1.0.18 WebGL Build.data",
        frameworkUrl: buildUrl + "/1.0.18 WebGL Build.framework.js",
        codeUrl: buildUrl + "/1.0.18 WebGL Build.wasm",
