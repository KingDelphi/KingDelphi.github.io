(function () {
    ...
    //UNITY STUFF
    var buildUrl = "Build";
    var loaderUrl = buildUrl + "/1.0.11 WebGL Build.loader.js";
    var config = {
        dataUrl: buildUrl + "/1.0.11 WebGL Build.data",
        frameworkUrl: buildUrl + "/1.0.11 WebGL Build.framework.js",
        codeUrl: buildUrl + "/1.0.11 WebGL Build.wasm",
